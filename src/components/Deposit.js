        ...
        <table className="table table-borderless text-muted text-center">
          ...
          <tbody>
            <tr>
              ...
              <td>{window.web3.utils.fromWei(this.props.userInfo.rewardDebt, 'Ether')}</td>
            ...
            <form className="mb-3" onSubmit={(event) => {
              ...
              <div>
                ...
                <span className="float-right text-muted">
                  mUni Balance: {window.web3.utils.fromWei(this.props.uniTokenBalance, 'Ether')}
                </span>
              </div>
